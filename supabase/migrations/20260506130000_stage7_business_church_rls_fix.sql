-- Stage 7 fix: Restaurar RLS de acesso individual e adicionar church_admin/admin global somente como extensão

-- profiles: restaurar acesso próprio e estender para church_admin Business e admin global
...
-- pre_sermons: restaurar acesso próprio e estender para church_admin Business e admin global
...
-- published_sermons: restaurar acesso próprio e estender para church_admin Business e admin global
...
-- publication_events: restaurar acesso próprio e estender para church_admin Business e admin global
