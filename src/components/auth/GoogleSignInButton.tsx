...
export function GoogleSignInButton({ next = "/lider/sermoes" }: Props) {
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className="w-full flex items-center justify-center gap-3 rounded-2xl border border-[var(--mt-border)] bg-white/5 px-4 py-3 text-sm font-semibold text-[var(--mt-white)] transition-colors duration-200 hover:bg-white/10"
    >
      <GoogleIcon />
      Entrar com Google
    </button>
